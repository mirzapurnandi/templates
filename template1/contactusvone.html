								...
								<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
									<ul>
										...
										<li class="menu-item-has-children current-menu-item">
											...
											<ul class="sub-menu">
												<li class="current-menu-item"><a href="contactusvone.html">Contact us V-one</a></li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active">contact v one</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div id="tg-campuscarousel" class="tg-campuscarousel owl-carousel tg-campuses">
							...
							<div class="item">
								<div class="tg-campus">
									<figure class="tg-featuredimg">
										<a href="javascript:void(0);">
											<img src="images/campuses/img-10.jpg" alt="image description">
										</a>
									</figure>
									<ul class="tg-capmusinfo">
										<li>
							...
							<div class="item">
								<div class="tg-campus">
									<figure class="tg-featuredimg">
										<a href="javascript:void(0);">
											<img src="images/campuses/img-11.jpg" alt="image description">
										</a>
									</figure>
									<ul class="tg-capmusinfo">
										<li>
