										...
										<li class="menu-item-has-children current-menu-item">
											...
											<ul class="sub-menu">
												<li class="menu-item-has-children current-menu-item">
													...
													<ul class="sub-menu">
														<li class="current-menu-item"><a href="aboutcampuslife.html">Our Campus Life</a></li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active">campus life</li>
						</ol>
					</div>
				</div>
			</div>
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<div class="tg-widgetcontent">
										<ul>
											...
											<li class="tg-active"><a href="javascript:void(0);">Campus Life</a></li>
										</ul>
									</div>
								</div>
							</aside>
								...
								<div id="tg-content" class="tg-content">
									<div class="tg-aboutus tg-campuslife">
										<figure>
											...
											<a class="tg-btnplay" href="javascript:void(0);"></a>
										</figure>
										<div class="tg-description">
											<h3>Campus Life</h3>
