											...
											<ul class="sub-menu">
												<li class="menu-item-has-children current-menu-item">
													...
													<ul class="sub-menu">
														...
														<li class="current-menu-item"><a href="aboutvisionmission.html">Our Missions</a></li>
													</ul>
												</li>
												<li class="menu-item-has-children">
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-aboutus tg-visionmission">
									...
									<h3>Our Mission</h3>
									<p>Sedpiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium sasi totam rem aperiam eaque ipsa quae ab illotation inventore veritatis etanas quasi architecto beatae vitae dicta explicabo Nemo enim ipsam aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos ratione voluptatem sequi nesciunt. Neque porro quisquam estion.</p>
								</div>
							</div>
						</div>
					</div>
